...
class UserIdeasInProgressStatusTest extends TestCase
{
    /**
    ...
    public function My_ideas_displaying_correctly()
    {
        ...
        $this->actingAs($user)
            ->get("/statusfilter/inprogress?user=true")
    ...
    public function my_ideas_paginating_correctly()
    {
        ...
        Idea::factory(10)->create(["user_id" => $user->id, "status_id" => $statusInProgress->id]);
        ...
        $this->actingAs($user)
            ->get("/statusfilter/inprogress?user=true&page=2")
    ...
    public function ideas_filter_on_all_status_based_on_categories_for_user_displaying()
    {
        ...
        $this->actingAs($user)
            ->get("/statusfilter/inprogress?user=true&category=1")
    ...
    public function ideas_filter_on_all_status_based_on_categories_for_user_pagination_working()
    {
        ...
        $this->actingAs($user)
            ->get("/statusfilter/inprogress?user=true&category=1&page=2")
            ->assertInertia(function (Assert $page) use ($idea) {
                $page->component("HomePage")
                    ->has("ideas", function (Assert $page) use ($idea) {
                        $page->has("data", 1)
    ...
    public function Guest_when_goes_to_user_filtered_endpoint_they_see_a_login_page()
    {
        ...
        $response = $this->get("/statusfilter/inprogress?user=true&category=1&page=2");
