            ...
            <Dropdown.Content hasLinks={false} width="w-2full" align="left">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mt-4 ml-4 w-full flex items-center">
                        <input type="radio" id="open" name="statusOpen" value="OPEN" onChange={handleRadioSeletion} />
                        <InputLabel className='font-semibold ml-4' htmlFor="open">Open</InputLabel>
                    </div>

                    <div className="mt-4 ml-4 w-full flex items-center">
                        <input type="radio" id="considering" name="statusConsidering" value="CONSIDERING" onChange={handleRadioSeletion} />
