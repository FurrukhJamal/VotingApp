...
function NotificationMessage({ message, hideNotification }) {
    return (
        <div dusk="notificationTab" className="flex max-w-sm w-full justify-between fixed bottom-0 right-0 bg-white rounded-xl shadow-lg border px-6 py-5 mx-6 my-8">
